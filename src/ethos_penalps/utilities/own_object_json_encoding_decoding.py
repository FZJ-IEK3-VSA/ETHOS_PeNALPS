...
#                 start_process_step_name=static_data_dictionary["start_process_step_name"],
...
#                 minimum_batch_mass_value=static_data_dictionary["minimum_batch_mass_value"],
#                 maximum_batch_mass_value=static_data_dictionary["maximum_batch_mass_value"],
#                 mass_unit=Units.get_unit(mass_unit_dict["unit"]),
#                 name_to_display=static_data_dictionary["name_to_display"],
#             )
#         )

#     def decode_ContinuousStream(self, continuous_stream_dictionary: dict) -> ContinuousStream:
...
#                 operation_rate_unit=datetime.timedelta(seconds=static_data_dictionary["time_unit"]),
#             )
#         )
...
#                 pass
#             else:
#                 stream_static_data_dict = json.loads(stream_static_data_dict_str["static_data"])

#                 if stream_static_data_dict["stream_type"] == "ContinuousStream":
#                     static_data = ContinuousStreamStaticData.from_dict(stream_static_data_dict)
#                     decoded_stream = ContinuousStream(static_data=static_data)
#                 elif stream_static_data_dict["stream_type"] == "BatchStream":
#                     static_data = BatchStreamStaticData.from_dict(stream_static_data_dict)
#                     decoded_stream = BatchStream(continuous_stream_static_data=static_data)
