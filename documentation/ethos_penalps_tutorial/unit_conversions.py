...
energy_in_6_minutes_full_power_heating = 2000 * Units.unit_registry.Unit("W") * 6 * Units.unit_registry.Unit("minutes")
print(
...
energy_water_20_to_100_degree = 650 * Units.unit_registry.Unit("gram") * 80 * Units.unit_registry.Unit("K") * cp_water
...
#
specific_energy_heating_state = (energy_water_20_to_100_degree) / (650 * Units.unit_registry.Unit("gram"))
print(
...
specific_energy_hold_temperature_state = (total_cooking_energy - energy_water_20_to_100_degree) / (
...
specific_energy_blending_state = (1300 * Units.unit_registry.Unit("W") * 5 * Units.unit_registry.Unit("minutes")) / (
    650 * Units.unit_registry.Unit("gram")
)
print("Specific energy demand blending state", specific_energy_blending_state.to("MJ/t"))
