...
def define_and_start_simulation():
    ...
    raw_goods_source = blending_network_level.create_main_source("Raw Goods", commodity=raw_commodity)
    blending_network_level.add_process_chain_storage_as_sink(process_chain_storage=uncooked_goods_storage)
