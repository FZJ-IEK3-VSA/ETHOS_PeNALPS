...
def define_and_start_simulation():
    ...
    conti_output_state = process_step.process_state_handler.create_continuous_output_stream_providing_state(
        process_state_name="conti output state"
    )
    ...
    output_providing_activation = process_step.process_state_handler.process_state_switch_selector_handler.process_state_switch_handler.create_process_state_switch_at_output_stream(
        ...
        end_process_state=conti_output_state,
    )
    ...
    idle_state_activation = process_step.process_state_handler.process_state_switch_selector_handler.process_state_switch_handler.create_process_state_switch_at_next_discrete_event(
        start_process_state=conti_output_state,
    ...
    batch_input_state_activation = process_step.process_state_handler.process_state_switch_selector_handler.process_state_switch_handler.create_process_state_switch_at_input_stream(
        start_process_state=batch_idle_state,
        end_process_state=batch_input_state,
    )
    batch_state_reactivation = process_step.process_state_handler.process_state_switch_selector_handler.process_state_switch_handler.create_process_state_switch_at_input_stream(
        start_process_state=batch_input_state,
        end_process_state=batch_input_state,
    )
    process_step.process_state_handler.process_state_switch_selector_handler.create_batch_state_switch_selector(
        further_input_is_required_switch=batch_state_reactivation,
        input_is_satisfied_switch=batch_input_state_activation,
    )
