...
def define_and_start_simulation():
    ...
    standard_simulation_report.gantt_charts.add_plot_start_and_end_time(
        start_time=time_data.global_end_date - datetime.timedelta(hours=28),
        end_time=time_data.global_end_date,
    )
