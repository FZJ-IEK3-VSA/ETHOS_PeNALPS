...
from test.tests.production_plan_tests.cutting_and_heating_chain import (
    fill_cutting_and_heating_chain,
)
from test.tests.production_plan_tests.forming_quenching_and_trimming_chain import (
...
def test_write_production_plan():
    ...
    path_to_stream_database = str(os.path.abspath(os.path.join(path_to_current_file, "stream_result.db")))
    path_to_process_step_database = str(os.path.abspath(os.path.join(path_to_current_file, "process_step_result.db")))
    list_of_output_file_paths = enterprise.production_plan.save_all_simulation_results_to_sqlite(
