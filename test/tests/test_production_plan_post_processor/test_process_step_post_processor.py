...
from test.tests.test_production_plan_post_processor.cutting_and_heating_chain import (
    fill_cutting_and_heating_chain,
)
from test.tests.test_production_plan_post_processor.forming_quenching_and_trimming_chain import (
...
def test_production_plan_post_processor():
    ...
    cutting_and_heating_level.add_process_chain_storage_as_sink(process_chain_storage=hot_part_storage)
    ...
    for (
        ...
        list_of_input_stream_states = enterprise.production_plan.stream_state_dict[input_stream_name]
        list_of_output_stream_states = enterprise.production_plan.stream_state_dict[output_stream_name]
        ...
        earliest_process_step_time = process_step_post_processor.get_earliest_start_date_process_step()
        latest_process_step_time = process_step_post_processor.get_latest_end_date_process_step()
