...
class TestLoadProfileAnalyzer(SmallLoadProfileEntryGenerator):
    def test_correct_order_load_profiles(self):
        ...
        with warnings.catch_warnings():
            ...
            load_profile_entry_meta_data = (
                list_of_load_profile_entry_analyzer.create_list_of_load_profile_entry_meta_data(
    ...
    def test_correct_0_time_length_order_load_profiles(self):
        ...
        with warnings.catch_warnings():
            warnings.simplefilter(action="error", category=LoadProfileInconsistencyWarning)
            list_of_load_profiles = self.create_three_load_profiles_with_0_length_entry()
            list_of_load_profile_entry_analyzer = ListOfLoadProfileEntryAnalyzer()
            load_profile_meta_data = list_of_load_profile_entry_analyzer.create_list_of_load_profile_entry_meta_data(
                list_of_load_profiles=list_of_load_profiles,
                object_name="Test Object",
    ...
    def test_wrong_energy_power_combination(self):
        ...
        with warnings.catch_warnings():
            pytest.warns(LoadProfileInconsistencyWarning)
            list_of_load_profiles = self.create_load_profile_with_wrong_power_and_energy_combination()
            list_of_load_profile_entry_analyzer = ListOfLoadProfileEntryAnalyzer()
            load_profile_meta_data = list_of_load_profile_entry_analyzer.create_list_of_load_profile_entry_meta_data(
                list_of_load_profiles=list_of_load_profiles,
                object_name="Test Object",
    ...
    def test_wrong_combinations_of_load_types(self):
        ...
        with warnings.catch_warnings():
            pytest.warns(LoadProfileInconsistencyWarning)
            list_of_load_profiles = self.create_two_load_profiles_with_different_load_type()
            list_of_load_profile_entry_analyzer = ListOfLoadProfileEntryAnalyzer()
            load_profile_meta_data = list_of_load_profile_entry_analyzer.create_list_of_load_profile_entry_meta_data(
                list_of_load_profiles=list_of_load_profiles,
                object_name="Test Object",
