...
from test.tests.application_examples.test_toffee_production.cutting_and_packaging_chain import (
    fill_cutting_and_packaging_chain,
)
from test.tests.application_examples.test_toffee_production.toffee_preparation_chain_1 import (
    fill_toffee_preparation_chain_1,
)
from test.tests.application_examples.test_toffee_production.toffee_preparation_chain_2 import (
    fill_toffee_preparation_chain_2,
)


def test_toffee_production():
    ...
    toffee_production_level.add_process_chain_storage_as_sink(process_chain_storage=cooled_toffee_storage)
    ...
    toffee_packaging_chain = toffee_packaging_level.create_process_chain(process_chain_name="Cutting and Packaging")
