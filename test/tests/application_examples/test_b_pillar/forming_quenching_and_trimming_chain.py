...
def fill_forming_quenching_and_trimming_chain(
    ...
    forming_and_quenching_machine = process_chain.create_process_step(name="Forming Quenching")
    ...
    discharge_press_state = (
        forming_and_quenching_machine.process_state_handler.create_batch_output_stream_providing_state(
            process_state_name="Discharge"
        )
    )
    idle_press_state = forming_and_quenching_machine.process_state_handler.create_idle_process_state(
    ...
    trimming_state = (
        trimming_machine.process_state_handler.create_intermediate_process_state_energy_based_on_stream_mass(
    ...
    idle_trimmer_state = trimming_machine.process_state_handler.create_idle_process_state(process_state_name="Idle")
    ...
    trimming_machine.process_state_handler.process_step_data.main_mass_balance.create_storage(current_storage_level=0)
